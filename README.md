...
- **탐색 = open board** — 마감 전 RFP는 공개 게시판에 노출, 단 참여 판단에 필요한 비경쟁 정보만 공개 (견적번호·구매사명·제목·홈페이지·마감일·요청 결제수단·주요 상품·계약 유형). 수수료·현재 거래조건·연거래액·사업자번호·메모·첨부 등 경쟁 정보는 쿼리 레이어 화이트리스트로 차단
