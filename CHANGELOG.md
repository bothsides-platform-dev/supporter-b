...
- **카드·간편결제 수수료를 가맹점 규모 구간별로 제안**: 견적을 작성할 때 카드와 간편결제 수수료를 영세·중소1·중소2·중소3·일반 5구간(여신금융협회 우대수수료 기준)으로 묶어 한눈에 입력합니다. 수단마다 구간별 요율을 다르게 제안할 수 있고, 계좌·기타 수단은 기존처럼 단일 요율로 받습니다.
