  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <button type="button" className="block w-full text-center md-label-small text-[var(--md-sys-color-on-surface-variant)] hover:text-[var(--md-sys-color-on-surface-variant)] transition-colors">
          거절하기
        </button>
      </div>
    </div>
