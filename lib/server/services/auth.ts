...
export class AuthService {
  ...
  async completeSignup(input: {
    ...
    wsKind: 'buyer' | 'pg';
    wsName: string;
    bizProfile?: { bizNo: string; taxType: 'general' | 'simple' | 'exempt'; status: 'active' | 'suspended' | 'closed'; grade?: 'general' | 'sole' | 'sme1' | 'sme2' | 'sme3'; gradeSource?: 'user_confirmed' | 'user_overridden' | 'unset' };
