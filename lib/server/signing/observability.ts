...
const TRANSIENT_CODES = new Set(['SNOWSIGN_NETWORK', 'SNOWSIGN_UNREACHABLE', 'SNOWSIGN_RATE_LIMIT']);
 ...
 * 자가치유 transient(NETWORK/UNREACHABLE/RATE_LIMIT)는 스킵한다. **PII 금지** — 참여자 email/name 은
