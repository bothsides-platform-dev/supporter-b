...
// or `@/lib/db/client` (`import type { DB }` is fine; services take their tx
// handle from repositories/factory `getDb()`). This list is the small set of files that
...
export const DB_BOUNDARY_ALLOWLIST = [
  ...
  // pglite test double) into action transactions. Still used by 3 actions:
  // auth/loginAction, rfp/setRfpBoardVisibilityAction,
  // rfp/updateWorkspaceBizProfileAction. Services no longer use it (they take
  // `getDb()` from repositories/factory).
