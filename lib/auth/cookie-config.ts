 ...
 *
 * AUTH_COOKIE_DOMAIN='.support-b.com' makes the cookie valid on both
 * support-b.com and partner.support-b.com (cross-host SSO). Leave unset
 ...
 * (Domain 속성 없음)이고, 이후 발급분은 Domain=.support-b.com 으로 스코프된다.
