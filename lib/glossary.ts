...
export const GLOSSARY = {
  ...
  보증보험: {
    label: '보증보험',
    description:
      '정산·환불 사고에 대비해 PG가 요구하는 보증이에요. 금액이 작을수록 부담이 적어요.',
  },
  수수료율: {
    label: '수수료율',
    description:
      '결제 금액에서 PG가 가져가는 비율이에요. 1만 원을 결제받고 수수료율이 3%면 300원이 빠져요.',
  },
  가맹점등급: {
    label: '가맹점 등급',
    description:
      '연 매출 규모로 나뉘는 카드 우대 등급이에요. 영세·중소 등급일수록 카드 수수료를 법으로 낮게 보장받아요.',
  },
  법정고정수수료: {
    label: '법정 고정수수료',
    description:
      '영세·중소 가맹점에 법으로 정해 둔 카드 수수료예요. PG가 마음대로 올리거나 내릴 수 없어요.',
  },
  카드우대수수료: {
    label: '카드 우대수수료',
    description:
      '매출이 작은 가맹점에 적용하는 낮은 카드 수수료예요. 등급에 따라 자동으로 정해져요.',
  },
  과세유형: {
    label: '과세유형',
    description:
