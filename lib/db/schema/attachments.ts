...
// pair. Exactly one of rfp_id / bid_id / bid_note_id / chat_message_id is set
// once linked; all NULL is allowed for draft uploads (file uploaded before its
// owner row exists). CHECK enforces "at most one" so an attachment can never
// point at multiple owners. Bytes live 1:1 in attachment_blobs keyed by this
// id (C4).
export const attachments = pgTable(
  ...
  (t) => [
    check(
      ...
      sql`num_nonnulls(${t.rfpId}, ${t.bidId}, ${t.bidNoteId}, ${t.chatMessageId}) <= 1`,
    ),
