...
describe('SigningSendEmbed', () => {
  it('renders the SnowSign iframe with the issued url', () => {
    render(<SigningSendEmbed iframeUrl={IFRAME_SRC} onComplete={vi.fn()} onClose={vi.fn()} />);
  ...
  it('closes on the close button', async () => {
    ...
    render(<SigningSendEmbed iframeUrl={IFRAME_SRC} onComplete={vi.fn()} onClose={onClose} />);
