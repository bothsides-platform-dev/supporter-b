...
export function IconSidebar({ workspaceType }: Props) {
  ...
  return (
    <nav
      ...
      aria-label="기본 내비게이션"
      className="fixed inset-y-0 left-0 z-30 h-svh w-[var(--shell-rail)] flex flex-col items-center py-4 bg-[var(--shell-rail-bg)]"
    >
      <div className="mb-8">
              ...
              <div
                className={cn(
                  ...
                  isActive
                    ...
                    : 'text-[var(--shell-rail-fg)] hover:bg-[color-mix(in_srgb,var(--shell-rail-fg)_8%,transparent)]',
                )}
              >
