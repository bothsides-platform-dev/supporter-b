      ...
      <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] gap-[var(--s-8)] md:gap-0">
        ...
        <div className="flex flex-col gap-[var(--s-8)] md:border-r md:border-[var(--md-sys-color-outline-variant)] md:pr-[var(--s-8)]">
          <div className="flex flex-col gap-[var(--s-3)]">
            <div className="flex items-baseline justify-between">
              <span className="font-mono text-sm tracking-[0.02em] md:tracking-[0.1em] uppercase whitespace-nowrap text-[var(--md-sys-color-on-surface-variant)]">연간 거래액</span>
              <span className="font-mono tabular-nums text-sm text-[var(--md-sys-color-on-surface)] tracking-[0.02em] whitespace-nowrap shrink-0">
                {formatVolume(volume)}
              </span>
            </div>
            <div
          ...
          <div className="flex flex-col gap-[var(--s-3)]">
            <div className="flex items-baseline justify-between">
              <span className="font-mono text-sm tracking-[0.02em] md:tracking-[0.1em] uppercase whitespace-nowrap text-[var(--md-sys-color-on-surface-variant)]">현재 PG 수수료율</span>
              <span className="font-mono tabular-nums text-sm text-[var(--md-sys-color-on-surface)] tracking-[0.02em] whitespace-nowrap shrink-0">
            ...
            <div className="flex justify-between font-mono text-sm tracking-[0.1em] text-[var(--md-sys-color-on-surface-variant)] uppercase">
        ...
        <div className="flex flex-col md:pl-[var(--s-8)]">
          <div className="flex flex-col gap-[var(--s-2)]">
            <span className="font-mono text-sm tracking-[0.1em] uppercase text-[var(--md-sys-color-on-surface-variant)]">
              예상 연간 절감액
            </span>
            <div className="flex items-baseline gap-3 flex-wrap">
              ...
              {currentCost > 0 && (
                <span className="font-mono tabular-nums text-sm tracking-[0.06em] text-[var(--md-sys-color-on-surface-variant)]">
