    ...
    const mixed: InboxListItem[] = [
      {
        ...
        key: 'c:c1',
        conversationId: 'c1',
        counterparty: { workspaceId: 'w', name: '토스', type: 'pg', hasLogo: false, logoUpdatedAt: null },
        rfpId: null,
        rfpCode: null,
        rfpTitle: null,
        rfpStatus: null,
    ...
    const mixed: InboxListItem[] = [
      {
        ...
        conversationId: 'c1',
        counterparty: { workspaceId: 'w1', name: '토스페이', type: 'pg', hasLogo: false, logoUpdatedAt: null },
